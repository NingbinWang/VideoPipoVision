#ifndef SYS_SOCKET_INTERFACE_H
#define SYS_SOCKET_INTERFACE_H
 ...
 */
CHAR *sys_socket_inet_ntoa(struct sys_in_addr stIn);
 ...
 */
INT32 sys_socket_get_tcp_state(INT32 iSockFd);

/**
 * @brief      获取套接字错误码
 * @return     详见errno 
 */
INT32 sys_socket_get_last_errno(VOID);

#ifdef __cplusplus
}
#endif/*__cplusplus*/

#endif/* SYS_SOCKET_INTERFACE_H */

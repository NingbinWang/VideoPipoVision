#ifndef SYS_NET_INTERFACE_H
#define SYS_NET_INTERFACE_H
...
/**
 * @brief      获取网卡序列号
 * @param[in]  strEhtName 设备名字
 * @param[out] puIndex   网卡名称对应序列号
 * @return     成功返回0;错误，返回 -1
 */
INT32 sys_net_get_eth_index(const CHAR *strEhtName, UINT8 *puIndex);
